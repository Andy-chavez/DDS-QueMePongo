...
public class DAOTipo implements DAO {
    ...
    public void iniciarBase() { //(String nombre, Categoria c,List<Tela> telaList, int capa, int abrigo){
        ...
        Tipo camisa = new Tipo("Camisa",new Superior(),algNylPolYSed,1,12);
        Tipo campera = new Tipo("Campera",new Superior(),algNylPolYSed,3,25);
        Tipo musculosa = new Tipo("Musculosa",new Superior(),algNylPolYSed,0,8);
        ...
        Tipo remera = new Tipo("Remera",new Superior(),algNylPolYSed,0,10);
        Tipo shorts = new Tipo("Shorts",new Inferior(),algNylPolYSed,0,15);
        Tipo sweater = new Tipo("Sweater",new Superior(),algNylPolYSed,2,12);
