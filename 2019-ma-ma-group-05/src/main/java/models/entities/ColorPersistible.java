...
@Entity
@Table(name = "color_persistible")
public class ColorPersistible extends EntidadPersistente implements java.io.Serializable {
...
//    }
//
//    public void setHexa(Color hexa) {
//        this.hexa = hexa.getRGB();
//    }
     ...
     * @since 1.4
     */
    public static final ColorPersistible WHITE = white;

    /**
     * The color light gray.  In the default sRGB space.
     */
    public static final ColorPersistible lightGray = new ColorPersistible(192, 192, 192);
     ...
     * @since 1.4
     */
    public static final ColorPersistible LIGHT_GRAY = lightGray;

    /**
     * The color gray.  In the default sRGB space.
     */
    public static final ColorPersistible gray = new ColorPersistible(128, 128, 128);
     ...
     * @since 1.4
     */
    public static final ColorPersistible GRAY = gray;

    /**
     * The color dark gray.  In the default sRGB space.
     */
    public static final ColorPersistible darkGray = new ColorPersistible(64, 64, 64);
     ...
     * @since 1.4
     */
    public static final ColorPersistible DARK_GRAY = darkGray;

    /**
     * The color black.  In the default sRGB space.
     */
    public static final ColorPersistible black = new ColorPersistible(0, 0, 0);
     ...
     * @since 1.4
     */
    public static final ColorPersistible BLACK = black;

    /**
     * The color red.  In the default sRGB space.
     */
    public static final ColorPersistible red = new ColorPersistible(255, 0, 0);
     ...
     * @since 1.4
     */
    public static final ColorPersistible RED = red;

    /**
     * The color pink.  In the default sRGB space.
     */
    public static final ColorPersistible pink = new ColorPersistible(255, 175, 175);
     ...
     * @since 1.4
     */
    public static final ColorPersistible PINK = pink;

    /**
     * The color orange.  In the default sRGB space.
     */
    public static final ColorPersistible orange = new ColorPersistible(255, 200, 0);
     ...
     * @since 1.4
     */
    public static final ColorPersistible ORANGE = orange;

    /**
     * The color yellow.  In the default sRGB space.
     */
    public static final ColorPersistible yellow = new ColorPersistible(255, 255, 0);
     ...
     * @since 1.4
     */
    public static final ColorPersistible YELLOW = yellow;

    /**
     * The color green.  In the default sRGB space.
     */
    public static final ColorPersistible green = new ColorPersistible(0, 255, 0);
     ...
     * @since 1.4
     */
    public static final ColorPersistible GREEN = green;

    /**
     * The color magenta.  In the default sRGB space.
     */
    public static final ColorPersistible magenta = new ColorPersistible(255, 0, 255);
     ...
     * @since 1.4
     */
    public static final ColorPersistible MAGENTA = magenta;

    /**
     * The color cyan.  In the default sRGB space.
     */
    public static final ColorPersistible cyan = new ColorPersistible(0, 255, 255);
     ...
     * @since 1.4
     */
    public static final ColorPersistible CYAN = cyan;

    /**
     * The color blue.  In the default sRGB space.
     */
    public static final ColorPersistible blue = new ColorPersistible(0, 0, 255);
     ...
     * @since 1.4
     */
    public static final ColorPersistible BLUE = blue;
...
//        }
     ...
     * @see #getRGB
     */
    public ColorPersistible(int r, int g, int b) {
        this(r, g, b, 255);
    ...
    public ColorPersistible(int r, int g, int b, int a) {
        value = ((a & 0xFF) << 24) |
                ((r & 0xFF) << 16) |
                ((g & 0xFF) << 8) |
                ((b & 0xFF) << 0);
     ...
     * @see #getRGB
     */
    public ColorPersistible(int rgb) {
     ...
     * @see #getRGB
     */
    public ColorPersistible(int rgba, boolean hasalpha) {
        if (hasalpha) {
            value = rgba;
        } else {
     ...
     * @see #getRGB
     */
    public ColorPersistible(float r, float g, float b) {
     ...
     * @see #getRGB
     */
    public ColorPersistible(float r, float g, float b, float a) {
     ...
     * @see #getColorComponents
     */
    public ColorPersistible(ColorSpace cspace, float[] components, float alpha) {
        boolean rangeError = false;
        String badComponentString = "";
     ...
     * @since 1.0
     */
    public ColorPersistible brighter() {
        int r = getRed();
        int g = getGreen();
        int b = getBlue();
        int alpha = getAlpha();
        ...
        if (r == 0 && g == 0 && b == 0) {
            return new ColorPersistible(i, i, i, alpha);
        }
        if (r > 0 && r < i) r = i;
        if (g > 0 && g < i) g = i;
        if (b > 0 && b < i) b = i;

        return new ColorPersistible(Math.min((int) (r / FACTOR), 255),
     ...
     * @since 1.0
     */
    public ColorPersistible darker() {
        return new ColorPersistible(Math.max((int) (getRed() * FACTOR), 0),
    ...
    public boolean equals(Object obj) {
        return obj instanceof ColorPersistible && ((ColorPersistible) obj).getRGB() == this.getRGB();
    }
     ...
     * @since 1.1
     */
    public static ColorPersistible decode(String nm) throws NumberFormatException {
        Integer intval = Integer.decode(nm);
        int i = intval.intValue();
        return new ColorPersistible((i >> 16) & 0xFF, (i >> 8) & 0xFF, i & 0xFF);
    }
     ...
     * @since 1.0
     */
    public static ColorPersistible getColor(String nm) {
     ...
     * @since 1.0
     */
    public static ColorPersistible getColor(String nm, ColorPersistible v) {
     ...
     * @since 1.0
     */
    public static ColorPersistible getColor(String nm, int v) {
        Integer intval = Integer.getInteger(nm);
        int i = (intval != null) ? intval.intValue() : v;
        return new ColorPersistible((i >> 16) & 0xFF, (i >> 8) & 0xFF, (i >> 0) & 0xFF);
    }
     ...
     * @since 1.0
     */
    public static ColorPersistible getHSBColor(float h, float s, float b) {
        return new ColorPersistible(HSBtoRGB(h, s, b));
    }
